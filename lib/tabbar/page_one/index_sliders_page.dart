...
class IndexSlidersPage extends StatefulWidget {
  @override
  _IndexSlidersPageState createState() => _IndexSlidersPageState();
}

class _IndexSlidersPageState extends State<IndexSlidersPage> {
  double _value1 = 20.0;
  double _value2 = 20.0;
  double _value3 = 35.0;
  Timer timer;
